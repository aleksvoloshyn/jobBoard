  ...
  return (
    <Container>
      {isLoading ? (
        ...
        <div className="jobDetails pb-9 px-4 pt-6 text-left bg-[white] text-detPrText desktop:flex desktop:gap-20 justify-start ">
          <div className="maininfo desktop:w-[793px]">
            {' '}
            <div className="detailsHeader desktop:flex">
              {' '}
              <hr className="text-hr opacity-10 mb-6 " />
              <h2 className="font-bold text-3xl leading-9 mb-3">Job Details</h2>
              <hr className="text-hr opacity-10 mb-6 desktop:hidden" />
              {/* user Panel */}
